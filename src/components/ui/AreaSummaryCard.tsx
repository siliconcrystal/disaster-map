...
export function AreaSummaryCard() {
  ...
  return (
    <div
      ref={cardRef}
      className={`absolute top-[136px] left-4 right-20 md:left-5 md:right-auto z-[1000] pointer-events-auto md:w-full md:max-w-[340px] bg-white/70 dark:bg-slate-900/70 backdrop-blur rounded-xl shadow-lg transition-all duration-300 overflow-hidden p-2`}
    >
      <div
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          <h2 className="text-[15px] font-bold text-slate-800 dark:text-slate-100 tracking-wide">
            花蓮光復災害應變中心
          </h2>
          {/* 公告按鈕：點擊不收合卡片 */}
          <button
